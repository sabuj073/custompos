...
use App\Http\Controllers\Notifications\PurchasePaymentDueController;
use App\Http\Controllers\Notifications\SalesPaymentDueController;
...
use App\Http\Controllers\PurchaseFinalizeController;
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::post('/home/submit-stock-alert', [HomeController::class, 'submitStockAlert'])->name('home.submitStockAlert');
    ...
    Route::post('/contacts/gettotaldamaged', [ContactController::class, 'gettotaldamaged']);
    Route::get('/contacts/customers', [ContactController::class, 'getCustomers']);
    Route::resource('contacts', ContactController::class);

    // Stock Alert Notifications
    Route::get('/stock-alert-notification', [StockAlertNotificationController::class, 'getProductStockAlert'])->name('stock-alert-notifications');
    Route::get('/purchases-payment-due', [PurchasePaymentDueController::class, 'getPurchasePaymentDues'])->name('stock-alert-notifications');
    Route::get('/sales-payment-due', [SalesPaymentDueController::class, 'getSalesPaymentDues'])->name('sales-payment-due-notifications');

    //purchase Finalize
    Route::get('/purchases-finalize', [PurchaseFinalizeController::class, 'index'])->name('finalizePurchase');
    Route::get('/purchases-finalize/{product_id}', [PurchaseFinalizeController::class, 'finalizeProduct'])->name('finalizeProduct');
    ...
    Route::get('/products/discount/{id}', [ProductController::class, 'discount']);

    Route::post('/products/discount_update', [ProductController::class, 'updateDiscount'])->name('products.updateDiscount');

    Route::get('/products/list', [ProductController::class, 'getProducts']);
    Route::get('/products/list-damaged', [ProductController::class, 'getProductsdamaged']);
    ...
    Route::post('/purchases/remove-from-session', [PurchaseController::class, 'rmvSession']);
    ...
    Route::get('/damaged-sells', [SellController::class, 'index_damaged']);
    ...
    Route::get('/sells/pos/get_product_row_damaged/{variation_id}/{location_id}', [SellPosController::class, 'getProductRowDamaged']);
    ...
    Route::get('/stock-damaged/remove-expired-stock/{purchase_line_id}', [DamagedProductController::class, 'removeExpiredStock']);
    Route::get('/stock-damaged/recoverAmount/{purchase_line_id}', [DamagedProductController::class, 'recoverAmount']);
    Route::post('/stock-damaged/get_product_row', [DamagedProductController::class, 'getProductRow']);
    Route::post('/stock-damaged/saveRecoveryAmount', [DamagedProductController::class, 'saveRecoveryAmount']);
    Route::resource('stock-damaged', DamagedProductController::class);
    ...
    Route::get('sells/damaged/', [SellController::class, 'selldamaged']);
    ...
    Route::post('storedamaged', [SellPosController::class, 'storedamaged']);
