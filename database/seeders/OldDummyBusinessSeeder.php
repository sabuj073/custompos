...
class OldDummyBusinessSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::insert("INSERT INTO contacts (id, business_id, type, supplier_business_name, name, 
					...
					(1, 1, 'customer', NULL, 'Running Customer', NULL, 'Phoenix', 'Arizona', 'USA', 'Linking Street', '(378) 400-1234', NULL, NULL, NULL, NULL, 1, 1, NULL, '2018-01-04 02:15:20', '2018-01-04 02:35:37'),
