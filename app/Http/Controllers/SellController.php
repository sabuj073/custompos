...
class SellController extends Controller
{
     ...
     public function index_damaged()
    {
        ...
        if (request()->ajax()) {
            ...
            $sells->where('transactions.is_damaged_sells',1);
        ...
        return view('sell.index_damaged')
    ...
    public function selldamaged(){
        ...
        return view('sell.create_damage_sell')
            ->with(compact(
                'business_details',
                'taxes',
                'walk_in_customer',
