...
@section('content')
    ...
    <section class="content">
        ...
        <span style="{{ $type == 'finalize' ? 'display: none;':'' }}">
        ...
        <div class="row" style="{{ $type == 'finalize' ? '':'display: none;' }}">
        ...
        @component('components.widget', ['class' => 'box-primary'])
            <div class="row">
                <div class="col-sm-4 @if (!session('business.enable_price_tax')) hide @endif" style="{{ $type == 'finalize' ? 'display: none;':'' }}">
                    <div class="form-group">
                ...
                <div class="clearfix" style="{{ $type == 'finalize' ? 'display: none;':'' }}"></div>
                <div class="col-sm-4" style="{{ $type == 'finalize' ? 'display: none;':'' }}">
                    <div class="form-group">
                ...
                <div class="text-center">
                    <div class="btn-group">
                        @if ($selling_price_group_count)
                            <button type="submit" style="{{ $type == 'finalize' ? 'display: none;':'' }}" value="submit_n_add_selling_prices"
                                class="btn btn-warning submit_product_form">@lang('lang_v1.save_n_add_selling_price_group_prices')</button>
                        @endif

                        @can('product.opening_stock')
                            <button type="submit" style="{{ $type == 'finalize' ? 'display: none;':'' }}" @if (empty($product->enable_stock)) disabled="true" @endif
                            ...
                            <button type="submit" style="{{ $type == 'finalize' ? 'display: none;':'' }}" value="save_n_add_another"
