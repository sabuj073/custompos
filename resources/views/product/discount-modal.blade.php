	...
	<div class="modal-content">
	    ...
	    <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <button type="submit" id="add_discount" onclick="adddiscount()" name="submit" class="btn btn-primary mt-24">Add Discount</button>
                </div>
      	...
      	<div class="modal-footer">
	        ...
	        <i class="fa fa-print"></i> @lang( 'messages.print' )
	      	...
	      	<button type="button" class="btn btn-default no-print" id="close_btn" data-dismiss="modal">@lang( 'messages.close' )</button>
	    </div>
	</div>
</div>
