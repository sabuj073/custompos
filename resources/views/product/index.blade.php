    ...
    @component('components.filters', ['title' => __('report.filters')])
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                {!! Form::select('sub_category_id', $sub_categories, null, ['class' => 'form-control select2', 'style' => 'width:100%', 'id' => 'product_list_filter_sub_category_id', 'placeholder' => __('lang_v1.all')]); !!}
            </div>
        </div>
...
@section('javascript')
    ...
    <script type="text/javascript">
        $(document).ready( function(){
            product_table = $('#product_table').DataTable({
                ...
                "ajax": {
                    ...
                    "data": function ( d ) {
                        ...
                        d.subcategory_id = $('#product_list_filter_sub_category_id').val();
            ...
            $(document).on('change', '#product_list_filter_sub_category_id','#product_list_filter_type, #product_list_filter_category_id, #product_list_filter_brand_id, #product_list_filter_unit_id, #product_list_filter_tax_id, #location_id, #active_state, #repair_model_id', 
                function() {
 ...
 var formData = {
            ...
            $.ajax({
                url: '{{ route("products.updateDiscount") }}',
                method: 'POST',
                data: formData,
