        ...
        @if($is_admin)
        	<div class="row">
        		...
        		{{-- <div class="col-md-2 col-xs-6">
                    <div style="margin-left: 85px;" class="form-group">
                          <div class="input-group">
                            <a href="#" style="padding: 6px 20px;" type="button" class="btn btn-primary">
                              <span>
    	   ...
    	   <div class="row">
                <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                   <div class="info-box info-box-new-style">
                        <span class="info-box-icon"><img src="{{ asset('sadax/images/total_sale.jpg') }}" alt=""></span>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                    <div class="info-box info-box-new-style">
                        <span class="info-box-icon"><img src="{{ asset('sadax/images/net.jpg') }}" alt=""></span>

                        <div class="info-box-content">
                          <span class="info-box-text">{{ __('lang_v1.net') }} @show_tooltip(__('lang_v1.net_home_tooltip'))</span>
                          <span class="info-box-number">{{ round($output['net'], 2) }}</span>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                    <div class="info-box info-box-new-style">
                        <span class="info-box-icon"><img src="{{ asset('sadax/images/invoice_due.jpg') }}" alt=""></span>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                    <div class="info-box info-box-new-style">
                        <span class="info-box-icon"><img src="{{ asset('sadax/images/sell_return.jpg') }}" alt=""></span>
                        <div class="info-box-content">
                          <span class="info-box-text">{{ __('lang_v1.total_sell_return') }}</span>
                          <span class="info-box-number ">{{ round($output['total_sell_return'], 2) }}</span>
                        </div>
                        <!-- /.info-box-content -->
    	    ...
    	    <!-- /.col -->
          	...
          	<div class="row">
                <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                   <div class="info-box info-box-new-style">
                    <span class="info-box-icon"><img src="{{ asset('sadax/images/total_purchase.jpg') }}" alt=""></span>
                        <div class="info-box-content">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                   <div class="info-box info-box-new-style">
                    <span class="info-box-icon"><img src="{{ asset('sadax/images/purchase_due.jpg') }}" alt=""></span>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                    <div class="info-box info-box-new-style">
                        <span class="info-box-icon"><img src="{{ asset('sadax/images/puchase.jpg') }}" alt=""></span>
                        <div class="info-box-content">
                          <span class="info-box-text">{{ __('lang_v1.total_purchase_return') }}</span>
                          <span class="info-box-number ">{{ round($output['total_purchase_return'], 2) }}</span>
                        </div>
                        <!-- /.info-box-content -->
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                    <div class="info-box info-box-new-style">
                        <span class="info-box-icon"><img src="{{ asset('sadax/images/expence.jpg') }}" alt=""></span>
                        <div class="info-box-content">
                      ...
                      <div class="row">
                            ...
                            <form action="{{ route('home.submitStockAlert') }}" method="POST">
                                ...
                                <div class="col-md-6 add_stock_btn">
                                    <button class="btn btn-sm btn-secondary" type="submit" style="margin-bottom: 10px;">Add Stock</button>
                                </div>
                                <div class="col-md-6">
                                            ...
                                            <select name="" id="sort_stock_alert" class="form-control">
                                                ...
                                                @foreach ($suppliers as $supplier)
                                                    @if ($supplier['supplier_id'] != NULL)
                                                        <option value="{{ $supplier['supplier_id'] }}" {{ request('supplier_id') == $supplier['supplier_id'] ? 'selected':'' }}>{{ getSupplierByID($supplier['supplier_id'])->name }}</option>
                                                    @endif
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <tbody>
                                            @if ($stock_alert_products->count() > 0)
                                                @foreach ($stock_alert_products as $stock_alert_item)
                                                    <tr>
                                                        <td style="width: 4%;">
                                                            <input type="checkbox" class="stock_check_box" name="stock_checkbox_ids[]" id="checkbox_alert_{{ $stock_alert_item->product_id }}" value="{{ $stock_alert_item->product_id }}" />
                                                        </td>
                                                        <td>
                                                            <label style="font-weight: normal;" for="checkbox_alert_{{ $stock_alert_item->product_id }}">{{ $stock_alert_item->product }}</label>
                                                        </td>
