<div class="modal-dialog modal-md" role="document">
  <div class="modal-content">
    ...
    <div class="modal-header">
      ...
      <h3 class="modal-title">Close Register 
        <span style="display: none;">( {{ \Carbon::createFromFormat('Y-m-d H:i:s', $register_details->open_time)->format('jS M, Y h:i A') }} - {{ \Carbon::now()->format('jS M, Y h:i A') }})</span>
      </h3>
    </div>

    <div class="modal-body">
        <h5>Are you sure? You want to close this register?</h5>
