<div class="modal-dialog modal-xl" role="document">
	<div class="modal-content">
		<div class="modal-header">
		    ...
		    <h4 class="modal-title" id="modalTitle"> @lang('lang_v1.stock_damaged_details') (<b>@lang('purchase.ref_no'):</b> #{{ $stock_adjustment->ref_no }})
		    </h4>
		</div>
    			...
    			<div class="col-sm-12 col-xs-12">
      				<div class="table-responsive">
      					<table class="table table-condensed bg-gray">
							...
							@foreach( $stock_adjustment->stock_damaged_lines as $stock_adjustment_line )
								<tr>
									<td>
